...
export default function TodoList() {
  ...
  useEffect(() => {
    try {
      axios.get("/pos/dashboard/addTodo").then((res) => {
        setTodoList(res.data.data);
      });
    } catch (e) {
  ...
  const delteTodo = (id) => {
    try {
      axios.delete(`/pos/dashboard/todo/delete/${id}`).then(() => {
                  ...
                  <div className="tools">
                    <i
                      onClick={() => {
                        try {
                          axios
                            .delete(`/pos/dashboard/todo/delete/${todo._id}`)
                            .then((res) => {
                              setTodoList(res.data.data)
                              toast.success("Removed");
                            });
